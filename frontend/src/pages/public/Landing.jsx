  ...
  return (
    <div className="relative overflow-hidden text-white bg-[#0a0e14]">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:30px_30px] md:bg-[size:50px_50px]" />
      </div>

      {/* ================= HERO ================= */}
      <section className="relative min-h-screen md:min-h-[95vh] flex items-center px-4 sm:px-6 z-10 pt-20 md:pt-0">

        <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center w-full">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-red-400 text-xs md:text-sm font-medium uppercase tracking-wider">Crafting Digital Excellence Since 2024</span>
            </div>
            ...
            <p className="mt-6 text-gray-300 text-sm md:text-base leading-relaxed max-w-lg mx-auto md:mx-0">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start flex-wrap">
              <button
                ...
                className="relative bg-gradient-to-r from-red-600 to-red-700 px-7 py-3 rounded-full font-semibold text-white shadow-lg shadow-red-600/40 hover:shadow-red-600/60 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 text-sm group"
              >
                <span>Explore Services</span> <ArrowRight size={16} className="group-hover:translate-x-1 transition" />
              </button>

              <button
                onClick={() => navigate("/quote")}
                className="relative border-2 border-red-500/40 px-7 py-3 rounded-full hover:border-red-500 transition-all duration-300 flex items-center justify-center gap-2 font-semibold text-sm group hover:bg-red-500/10 backdrop-blur-sm"
              >
                <span>Get Started</span> <ArrowRight size={16} className="group-hover:translate-x-1 transition" />
              </button>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-[320px] sm:max-w-[400px] md:max-w-none h-[350px] sm:h-[400px] md:h-[500px] rounded-2xl overflow-hidden">
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ repeat: Infinity, duration: 8, ease: "linear" }}
                className="absolute inset-0 bg-gradient-to-r from-red-500 via-yellow-400 to-red-500 p-[2px] rounded-2xl"
              >
                <div className="absolute inset-[2px] bg-[#0f141c] rounded-2xl" />
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-red-400 text-sm font-medium uppercase">What We Do</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Service Categories</h2>
            <p className="text-gray-400 mt-2 max-w-3xl mx-auto leading-relaxed text-sm md:text-base">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-white/6 to-white/2 border border-white/10 p-6 rounded-2xl hover:border-red-500/30 transition-all duration-300 h-full flex flex-col group-hover:shadow-lg group-hover:shadow-red-500/15">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-white group-hover:text-red-300 transition mb-2">{category.title}</h3>
                    <p className="text-gray-400 text-xs md:text-sm group-hover:text-gray-300 transition flex-1">{category.description}</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-red-400 text-sm font-medium uppercase tracking-widest">Proven Results</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Client Success Metrics</h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-sm md:text-base">Real impact delivered across diverse industries and project scopes.</p>
          </motion.div>
            ...
            {[
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white/6 to-white/2 border border-white/10 p-6 rounded-2xl hover:border-red-500/40 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-red-500/10 h-full flex flex-col">
                  <div className="mb-4">
                    <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-red-400 to-yellow-400 bg-clip-text text-transparent">{item.metric}</h3>
                    <p className="text-base md:text-lg font-semibold text-white mt-2 group-hover:text-yellow-300 transition">{item.result}</p>
                  </div>
                  <p className="text-xs md:text-sm text-gray-400 group-hover:text-gray-300 transition flex-1">{item.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="text-center mt-12 md:mt-16">
            ...
            >
              <span className="relative z-10 flex items-center gap-3 text-sm md:text-base">View Full Case Studies <ArrowRight size={16} className="group-hover:translate-x-1 transition" /></span>
            </button>
          </div>
        </div>
      </section>
      ...
      {/* ================= CTA ================= */}
      <section className="py-20 md:py-24 px-4 sm:px-6 relative z-10 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-yellow-200 to-red-300 bg-clip-text text-transparent">
              Let's Build Something Exceptional
            </h2>
            <p className="mb-10 text-gray-200 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
            ...
            >
              <span className="relative z-10 text-sm md:text-base">Start Your Journey</span>
